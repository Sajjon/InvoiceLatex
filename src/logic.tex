...
% LaTeX-ify Lua code
\newcommand{\daysOOO}{\directlua{get_env_with_default("OOO_DAYS", 3)}}
...
\newcommand{\invoiceNoOffset}{\directlua{get_env("INVOICE_NUMBER_BASE_OFFSET")}}
\newcommand{\invoiceNoOffsetNumberOfFreeMonths}{\directlua{get_env("INVOICE_NUMBER_MONTHS_FREE")}}
\newcommand{\invoiceNoOffsetDateMonth}{\directlua{get_env("INVOICE_NUMBER_BASE_OFFSET_DATE_MONTH")}}
\newcommand{\invoiceNoOffsetDateYear}{\directlua{get_env("INVOICE_NUMBER_BASE_OFFSET_DATE_YEAR")}}
\newcommand\invoiceNo{
    \invoiceNumberForPrevMonthWithDateAndOffsets
        {\invoiceNoOffset}                      % arg0
        {\invoiceNoOffsetNumberOfFreeMonths}    % arg1
        {\invoiceNoOffsetDateMonth}             % arg2
        {\invoiceNoOffsetDateYear}              % arg3
} % since OffsetDate above
